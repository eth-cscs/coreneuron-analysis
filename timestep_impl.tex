...
\begin{inlinelisting}{julia}{cell group data structure}
...
%*******************************************************************************
\filelisting [julia] {./code/fixed_step_thread.jl}{one time step}
%*******************************************************************************
...
\filelisting[julia]{./code/setup_tree_matrix.jl}{forming diagonal and right hand side of linear system}
...
\filelisting[julia]{code/jacob.jl}{updating the diagonal}
...
\filelisting [julia] {./code/current.jl}{calculating the current \& updating the right hand side}
...
\filelisting [julia] {./code/nrn_solve_minimal.jl}{solving the linear system}
...
\filelisting [julia] {./code/update.jl}{updating the solution}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\filelisting [julia] {./code/nonvint.jl}{non voltage integration}
...
\filelisting [julia] {./code/state.jl}{integrating the currents}
