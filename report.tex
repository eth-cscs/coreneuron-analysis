...
% this defines a note environment by defining a new theorem environment.
% it would be nice to look at creating a new environment type with a box
% box, title, and colour to make notes stand out.
\newtheorem{note}{Note}
